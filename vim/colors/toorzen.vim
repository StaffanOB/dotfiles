...
" Vim Color File
" Name:       toorzen.vim
" Maintainer: Based on onedark.vim by joshdick
" License:    The MIT License (MIT)
" Description: Toor-Zen colorscheme matching tmux-toor-zen-theme

" Color Reference {{{

" Toor-Zen Color Palette (from tmux-toor-zen-theme)

" +---------------------------------------------+
" |  Color Name  |         RGB        |   Hex   |
" |--------------+--------------------+---------|
" | Black        | rgb(24, 24, 24)    | #181818 |
" |--------------+--------------------+---------|
" | White        | rgb(204, 204, 204) | #cccccc |
" |--------------+--------------------+---------|
...
" |--------------+--------------------+---------|
" | Blue         | rgb(46, 158, 244)  | #2e9ef4 |
" |--------------+--------------------+---------|
" | Gray         | rgb(49, 49, 46)    | #31312E |
" |--------------+--------------------+---------|
" | Visual Grey  | rgb(54, 54, 54)    | #363636 |
" +---------------------------------------------+
...
let g:colors_name="toorzen"

" Set to "256" for 256-color terminals, or
" set to "16" to use your terminal emulator's native colors
if !exists("g:toorzen_termcolors")
  let g:toorzen_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:toorzen_terminal_italics")
  let g:toorzen_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `toorzen#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from toorzen#extend_highlight
  ...
  if g:toorzen_terminal_italics == 0
...
function! toorzen#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! toorzen#extend_highlight(group, style)
...
let s:colors = toorzen#GetColors()
